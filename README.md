...
I am a Technical Content Writer and Linguist.  
Here are some samples of my technical writing and user-focused documentation for software applications and ecosystems:  

## Published Manuals & Guides (Live Web Links)

### NamiraSoft Bill Watch
- **[NamiraSoft Bill Watch Console Guide (AWS)](https://namirasoft.com/bill-watch/console-guide/aws/)** – Step-by-step instructions for using the Bill Watch console.  
- **[NamiraSoft Bill Watch How It Works](https://namirasoft.com/bill-watch/how-it-works/)** – Overview of features and workflow explanations.  
...
- **[NamiraSoft How to Create AWS Access Keys](https://namirasoft.com/credential/how-to-create-aws-access-keys/)** – Step-by-step technical instructions for AWS credentials.  
...
- **[NamiraSoft Chrome Extension](https://chromewebstore.google.com/detail/namirasoft-password/fipanlkjkacopdpnhccphbdgdhmofepm)** – Guide for using the Chrome extension.
